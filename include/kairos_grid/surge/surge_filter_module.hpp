...
namespace surge {
    ...
    class SurgeFilterModule : public GridModule {
      public:
        ...
        void process(const GridProcessArgs&) override {
            ...
            alignas(16) const float in_arr[4] = {inputs[0].voltage * 0.2f, inputs[1].voltage * 0.2f,
                                                 0.f, 0.f};
      ...
      private:
        ...
        sst::filters::FilterCoefficientMaker<sst::filters::detail::BasicTuningProvider> coef_maker_;
    ...
    using DiodeLadderModule = SurgeFilterModule<FilterType::fut_diode, FilterSubType::st_Standard>;
    using K35LPModule       = SurgeFilterModule<FilterType::fut_k35_lp, FilterSubType::st_Standard>;
    using K35HPModule       = SurgeFilterModule<FilterType::fut_k35_hp, FilterSubType::st_Standard>;
